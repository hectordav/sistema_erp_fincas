               ...
               <!--  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                ...
                <li><a><i class="fa fa-edit"></i>Medidas<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="<?= $this->config->base_url();?>medida/grilla">Cargar Medidas</a>
                     ...
                     <ul class="nav child_menu" style="display: none">
                    <li><a href="<?= $this->config->base_url();?>medidas_valores/grilla">Cargar Valores de Medidas</a>
                    </li>                   
                  </ul>
                </li>
                ...
                <li><a><i class="fa fa-edit"></i>Empleados<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="<?= $this->config->base_url();?>empleado/grilla">Empleados</a>
                     ...
                     <li><a href="<?= $this->config->base_url();?>usuario/grilla">Usuarios</a>
                    </li>                   
                  </ul>
                </li>
                <li><a><i class="fa fa-edit"></i>Nomina<span class="fa fa-chevron-down"></span></a>
                 ...
                 <li><a><i class="fa fa-edit"></i>Informes <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="<?= $this->config->base_url();?>estado_resultados/add">Estado de Resultados</a>
                    </li>                   
                  </ul>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="<?= $this->config->base_url();?>ingreso/grilla">Ingressos</a>
                    </li>                   
                  </ul>
                  <ul class="nav child_menu" style="display: none">
                 ...
                 <li><a><i class="fa fa-edit"></i>Proveedores<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="<?= $this->config->base_url();?>proveedor/grilla">Proveedor</a>
                    </li>  
                     <li><a href="<?= $this->config->base_url();?>gasto_proveedor/grilla">Informe de Gastos X Proveedor</a>
                    </li>                   
                  </ul>
                </li>
