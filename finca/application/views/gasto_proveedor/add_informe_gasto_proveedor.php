  ...
  <?= validation_errors('<div class="alert alert-danger">','</div> ')?>
          ...
          <div class="animated fadeIn" align="left">
             <label><h3><strong>Crear Informe de Gastos por Proveedor</strong></h3></label>
             <hr>
        <form  role="form" action="<?php echo $this->config->base_url();?>gasto_proveedor/guardar_informe_gasto_proveedor" method="POST"  enctype="multipart/form-data">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <label>Finca</label>
          <select class="selectpicker form-control" name="id_proveedor" id="id_proveedor" data-show-subtext="true" data-live-search="true"  required="required">
